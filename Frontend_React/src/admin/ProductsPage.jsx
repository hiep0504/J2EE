...
function ProductsPage() {
  ...
  async function submitForm(event) {
    ...
    const uniqueSizeIds = new Set(normalizedSizes.map((item) => item.sizeId))
    if (uniqueSizeIds.size !== normalizedSizes.length) {
      alert('Bạn đang chọn trùng size. Mỗi size chỉ được xuất hiện một lần.')
      return
    }
