...
-- 6. orders (3 rows)
INSERT INTO orders (account_id, total_price, status, address, phone) VALUES
...
INSERT INTO order_details (order_id, product_size_id, quantity, price) VALUES
(1, 1, 2, 199000),
(1, 4, 1, 450000),
(2, 5, 1, 450000),
(3, 1, 1, 199000),
...
-- 8. reviews (4 rows)
INSERT INTO reviews (product_id, account_id, rating, comment) VALUES
